...
public class AssignmentTask4 {
    ...
    public static Node idGenerator(Node head1, Node head2, Node head3) {
        ...
        Node newHead = new Node(head1.elem);
        Node temp1 = head1;
        Node tempNew = newHead;

        while (temp1.next != null) {
            temp1 = temp1.next;
            Node copyNode = new Node(temp1.elem);
        ...
        while(temp2!=null && temp3!=null){
            int n=(int)temp2.elem + (int) temp3.elem;
            Node add;
            if(n<10){ 
             add = new Node(n);
            }else{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n=========Test Case 2=============");
        Node newHead = LinkedList.createList(new Integer[] { 0, 3, 9, 1 });
        ...
        LinkedList.printLL(newHead); // This should print 0 -> 3 -> 9 -> 1
        ...
        Node result2 = idGenerator(newHead, head5, head6);
